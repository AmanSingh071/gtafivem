...
-- Open-world location. The cafe is built directly in the GTA world; no shell/interior teleport.
...
-- Carefully chosen vanilla GTA props. The composition is intentionally original and is not a shell.
Config.Props = {
    -- Counter / service island
    ...
    { model = 'prop_bar_01', pos = vec3(-1222.65, -907.70, 12.60), rot = vec3(0.0, 0.0, 35.0), freeze = true },
    ...
    -- Patio / street-facing atmosphere
    ...
    -- Back-of-house / kitchen dressing
